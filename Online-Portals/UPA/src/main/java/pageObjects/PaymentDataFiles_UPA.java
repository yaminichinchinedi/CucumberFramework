...
public class PaymentDataFiles_UPA extends TestBase{
	...
	public PaymentDataFiles_UPA(TestBase testConfig) {
	...
	public PaymentDataFiles_UPA selectTin(String srchCriteria) 
	 {
        ...
        Element.selectByVisibleText(drpDwnTin, Prov_tin_nbr+" - Enrolled" ,"TIN Selection from Dropdown");
	...
	public PaymentDataFiles_UPA verifyCreateDataBundlePage() throws Exception
	{
		...
		Browser.wait(testConfig, 3);
		return  new PaymentDataFiles_UPA(testConfig);
	...
	public PaymentDataFiles_UPA verifyPayerList() throws InterruptedException, IOException
	{		Browser.wait(testConfig, 5);
		...
		//   testConfig.softAssert.assertEquals(PayerListUI, PayerListDB, "Available Payers:- ");
		   
		   return this;	
	}
	
	 public PaymentDataFiles_UPA verifyButtonsList() throws Exception
	 ...
	 public PaymentDataFiles_UPA verifyAddButton() throws Exception
	 ...
	 public PaymentDataFiles_UPA verifyAddAllButton() throws Exception
	 {
		 Browser.wait(testConfig, 3);
	 ...
	 public PaymentDataFiles_UPA verifyRemoveAllButton() throws Exception
	 {
		 Browser.wait(testConfig, 3);
		 List<WebElement> list2= Element.findElements(testConfig, "xpath", "//*[@name='selectedPayerTinNbrs']/option");
	 ...
	 public PaymentDataFiles_UPA verifyResetButton() throws Exception
	 {
		 Browser.wait(testConfig, 3);
		 List<WebElement> list1= Element.findElements(testConfig, "xpath", "//*[@name='availablePayerTinNbrs']/option");
		 Element.click(AddAllBtn, "Add All Button");
	 ...
	 public PaymentDataFiles_UPA verifyErrorWithoutSubmiitingAnyField() throws Exception
	 {
	 ...
	 public PaymentDataFiles_UPA verifyErrorWithoutSettlementDates() throws Exception
	 {
		 Element.click(ResetBtn, "Reset Button");
		 Browser.wait(testConfig, 3);
		 Element.click(RallyPayer, "Rally Payer");
	 ...
	 public PaymentDataFiles_UPA verifyErrorForPayerSelection() throws Exception
	 {
		 String date1 = currentDate();
		 Element.enterData(fromdate, date1, "From Date: "+date1, "fromdate");
		 Element.enterData(todate, date1, "To Date: "+date1, "todate");
	 ...
	 public PaymentDataFiles_UPA verifyPayerSelection() throws Exception
	 {
		 Element.click(AddAllBtn, "Add All Button");
		 Browser.wait(testConfig, 3);
		 return this;
	 ...
	 //to be modified
	 public PaymentDataFiles_UPA getTINnDate() 
	 {
		 int sqlRow=233;
	 ...
	 //to be modified - enter the payment date instead of current date
	 public PaymentDataFiles_UPA enterPaymentDate() throws InterruptedException 
	 {
	 ...
	 public PaymentDataFiles_UPA verifyAllFilesTypes() throws Exception
	 {
	 ...
	 public PaymentDataFiles_UPA verifySubmitEPRAsDataBundle() throws Exception
	 {
	 ...
	 public PaymentDataFiles_UPA verifySubmitPPRAsDataBundle() throws Exception
	 {
	 ...
	 public PaymentDataFiles_UPA verifySubmiteight35DataBundle() throws Exception
	 {
		 Element.click(Eight35ChkBox, "Click on 835 Check Box");
		 Element.click(btnSubmit, "Click on Submit Button");
		 Browser.wait(testConfig, 3);
	 ...
	 public PaymentDataFiles_UPA verifySubmiteprapraDataBundle() throws Exception
	 {
		 Element.click(eprachkbox, "Click on EPRA Check Box");
		 Element.click(prachkbox, "Click on PPRA Check Box");
		 //Element.click(Eight35ChkBox, "Click on 835 Check Box");
	 ...
	 public PaymentDataFiles_UPA verifySubmitepra835DataBundle() throws Exception
	 {
		 Element.click(eprachkbox, "Click on EPRA Check Box");
		 //Element.click(prachkbox, "Click on PPRA Check Box");
		 Element.click(Eight35ChkBox, "Click on 835 Check Box");
	 ...
	 public PaymentDataFiles_UPA verifySubmitppra835DataBundle() throws Exception
	 {
		 //Element.click(eprachkbox, "Click on EPRA Check Box");
		 Element.click(prachkbox, "Click on PPRA Check Box");
		 Element.click(Eight35ChkBox, "Click on 835 Check Box");
	 ...
	 public PaymentDataFiles_UPA verifySubmitAlltypeDataBundle() throws Exception
	 {
		 Element.click(eprachkbox, "Click on EPRA Check Box");
		 Element.click(prachkbox, "Click on PPRA Check Box");
		 Element.click(Eight35ChkBox, "Click on 835 Check Box");
	 ...
	 public PaymentDataFiles_UPA downloaddatabundle() throws Exception
	 {
		 ...
		 if(PageNote.contains(expectedNote)) {
			 Log.Comment("User has been navigated to Download Data Bundle Page. Text Displayed: "+PageNote);
		 }
		 else {
	 ...
	 public PaymentDataFiles_UPA eprafiletype() throws Exception
	 {
		 downloaddatabundle();
	 ...
	 public PaymentDataFiles_UPA pprafiletype() throws Exception
	 {
		 downloaddatabundle();
		 String FileType = BundleFileType.getText().trim();
	 ...
	 public PaymentDataFiles_UPA eight35filetype() throws Exception
	 {
		 downloaddatabundle();
		 String FileType = BundleFileType.getText().trim();
	 ...
	 public PaymentDataFiles_UPA epranpprafiletype() throws Exception
	 {
		 downloaddatabundle();
		 String FileType = BundleFileType.getText().trim();
	 ...
	 public PaymentDataFiles_UPA epran835filetype() throws Exception
	 {
		 downloaddatabundle();
		 String FileType = BundleFileType.getText().trim();
	 ...
	 public PaymentDataFiles_UPA ppran835filetype() throws Exception
	 {
		 downloaddatabundle();
		 String FileType = BundleFileType.getText().trim();
	 ...
	 public PaymentDataFiles_UPA epran835npprafiletype() throws Exception
	 {
		 downloaddatabundle();
		 String FileType = BundleFileType.getText().trim();
	 ...
	 public PaymentDataFiles_UPA downloadbundlePage() throws Exception
	 {
		 Element.click(DownloadDataBundle, "Click on Download Data Bundle Tab");
		 Browser.wait(testConfig, 3);
	 ...
	 public PaymentDataFiles_UPA getCompletedIN() 
	 {
		 int sqlRow=239;
	 ...
	 public PaymentDataFiles_UPA verifyZipFileName() 
	 {
	 ...
	 public PaymentDataFiles_UPA verifyDatabunldeDb()
		{
		...
		public PaymentDataFiles_UPA verify835Ind()
		{
			 verifyDatabunldeDb();
		...
		public PaymentDataFiles_UPA verifyEPRAInd()
		{
				verifyDatabunldeDb();
				String value835 = testConfig.getRunTimeProperty("835Ind").trim();
				String valuePPRA = testConfig.getRunTimeProperty("PPRAInd").trim();
		...
		public PaymentDataFiles_UPA verifyPPRAInd()
		{
				verifyDatabunldeDb();
				String value835 = testConfig.getRunTimeProperty("835Ind").trim();
				String valuePPRA = testConfig.getRunTimeProperty("PPRAInd").trim();
		...
		public PaymentDataFiles_UPA verifyEPRAnPPRAInd()
		{
				verifyDatabunldeDb();
				String value835 = testConfig.getRunTimeProperty("835Ind").trim();
				String valuePPRA = testConfig.getRunTimeProperty("PPRAInd").trim();
		...
		public PaymentDataFiles_UPA verifyEPRAn835Ind()
		{
				verifyDatabunldeDb();
				String value835 = testConfig.getRunTimeProperty("835Ind").trim();
				String valuePPRA = testConfig.getRunTimeProperty("PPRAInd").trim();
		...
		public PaymentDataFiles_UPA verifyPPRAn835Ind()
		{
				verifyDatabunldeDb();
				String value835 = testConfig.getRunTimeProperty("835Ind").trim();
				String valuePPRA = testConfig.getRunTimeProperty("PPRAInd").trim();
		...
		public PaymentDataFiles_UPA verifyEPRAn835nPPRAInd()
		{
				verifyDatabunldeDb();
				String value835 = testConfig.getRunTimeProperty("835Ind").trim();
				String valuePPRA = testConfig.getRunTimeProperty("PPRAInd").trim();
	 ...
	 public PaymentDataFiles_UPA clickSubmit()
	{
