...
//		 Helper.compareEquals(testConfig, "Record Count from FISL and DB :",totalRecordsFromFISL,getRecordCountFromDB(requestType));
	...
	{	
		...
		case "Market Type":
					...
					listString=getDetailsFromFISL(criteriaType,colName);
...
//		 Log.Comment("Details from FISL is :"  + '\n' +outerMap);
	...
	public List<String> getDetailsFromFISL(String requestType,String colName) throws ParseException, JAXBException, IOException, SAXException, ParserConfigurationException
	{
