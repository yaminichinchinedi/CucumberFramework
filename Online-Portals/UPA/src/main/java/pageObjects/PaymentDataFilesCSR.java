...
public class PaymentDataFilesCSR extends TestBase
{
	...
	public PaymentDataFilesCSR verifyAllValuesInCreateBundlePage() throws Exception{
		...
		testConfig.softAssert.assertEquals(StlDateRange.getText().trim(), "Settlement Date Range:", "Settlement Date Text Displaying.");
		 
		testConfig.softAssert.assertEquals(FileTypes.getText().trim(), "File Types:", "FileTypes Displaying.");
	   
		testConfig.softAssert.assertEquals(PayerSelection.getText().trim(), "Payer Selection:", "PayerSelection Header.");
	...
	public PaymentDataFilesCSR verifyErrorWithoutSubmittingAnyField() throws Exception
	{
		...
		testConfig.softAssert.assertEquals(Settlerror.getText(), "Settlement Date Range : From and To Dates are required.", "Settlement Error Displays");
		
		//to Verify Payer Selection Error
		testConfig.softAssert.assertEquals(PayerError.getText(), "Payer Selection : Missing Data", "Payer Error Displays");
		   
		//to Verify File Types Error
		testConfig.softAssert.assertEquals(FileError.getText(), "File Types : Missing Data", "File Type Error Displays: ");
	...
	public PaymentDataFilesCSR verifyErrorForPayerSelection() throws Exception
	{
		...
		testConfig.softAssert.assertEquals(PayerError.getText(), "Payer Selection : Missing Data", "Payer Selection Error Displays");
