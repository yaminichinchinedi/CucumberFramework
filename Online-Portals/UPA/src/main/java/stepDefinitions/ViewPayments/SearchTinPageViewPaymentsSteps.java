...
//    	payment.enterBSTin(paymentType, userType);
	...
	@When("^User Enters tin for \"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\"  and \"([^\"]*)\" for Portal Experience\\.$")
	public void user_Enters_tin_for_and_for_Portal_Experience(String userType, String searchCriteria, String tinType, String portalAccess) throws Throwable {
		testConfig.putRunTimeProperty("tinType", tinType);
    	testConfig.putRunTimeProperty("prdctSelected", portalAccess);
