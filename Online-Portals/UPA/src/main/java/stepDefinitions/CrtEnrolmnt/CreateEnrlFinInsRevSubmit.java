...
public class CreateEnrlFinInsRevSubmit extends TestBase{
	...
	@Then("^User navigates to Uploadw(\\d+) page and click on continue button on financial Institution Page$")
	public void user_navigates_to_Uploadw_page_and_click_on_continue_button_on_financial_Institution_Page(int arg1) throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
