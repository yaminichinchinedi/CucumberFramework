...
#Author: AMIT
  @CSR_ViewPayments_US2801170,US2879948 @OctRelease 
  Scenario Outline: Access Payments - View Payments Provider for Standard Experience
    ...
    Examples: 
			...
			|   		Super	 	  | 		PROV		|		Last 30 days	 |		 Standard		|		AV		|	Show All				|		Last 30 days		| 			New		  |ACTIVE_ARCHIVE_PAYMENTS_INDICATOR|	N|
			|   		Super	 	  | 		PROV		|		Last 30 days	 |		 Standard		|		VO		|	Show All				|		Last 30 days		| 			New		  |ACTIVE_ARCHIVE_PAYMENTS_INDICATOR|	N|
			|   		Super	 	  | 		PROV		|		Last 60 days	 |		 Standard		|		AO		|	Show All				|		Last 60 days		| 			New		  |ACTIVE_ARCHIVE_PAYMENTS_INDICATOR|	N|
			|   		Super	 	  | 		PROV		|		Last 60 days	 |		 Standard		|		AV		|	Show All				|		Last 60 days		| 			New		  |ACTIVE_ARCHIVE_PAYMENTS_INDICATOR|	N|
			|   		Super	 	  | 		PROV		|		Last 60 days	 |		 Standard		|		VO		|	Show All				|		Last 60 days		| 			New		  |ACTIVE_ARCHIVE_PAYMENTS_INDICATOR|	N|
			|   		Super	 	  | 		PROV		|		Last 90 days	 |		 Standard		|		AO		|	Show All				|		Last 90 days		| 			New		  |ACTIVE_ARCHIVE_PAYMENTS_INDICATOR|	N|
			|   		Super	 	  | 		PROV		|		Last 90 days	 |		 Standard		|		AV		|	Show All				|		Last 90 days		| 			New		  |ACTIVE_ARCHIVE_PAYMENTS_INDICATOR|	N|
      ...
      |   		Super	 	  | 		PROV		|	Last 4-6 months  |		 Standard		|		AO		|	Show All				|	Last 4-6 months		| 			New		  |ACTIVE_ARCHIVE_PAYMENTS_INDICATOR|	N|
			|   		Super	 	  | 		PROV		|	Last 4-6 months	 |		 Standard		|		AV		|	Show All				|	Last 4-6 months		| 			New		  |ACTIVE_ARCHIVE_PAYMENTS_INDICATOR|	N|
			|   		Super	 	  | 		PROV		|	Last 4-6 months  |		 Standard		|		VO		|	Show All				|	Last 4-6 months		| 			New		  |ACTIVE_ARCHIVE_PAYMENTS_INDICATOR|	N|
      |   		Super	 	  | 		PROV		| Last 6-9 months  |		 Standard		|		AO		|	Show All				|	Last 6-9 months		| 			New		  |ACTIVE_ARCHIVE_PAYMENTS_INDICATOR|	N|
			|   		Super	 	  | 		PROV		|	Last 6-9 months  |		 Standard		|		AV		|	Show All				|	Last 6-9 months		| 			New		  |ACTIVE_ARCHIVE_PAYMENTS_INDICATOR|	N|
			|   		Super	 	  | 		PROV		|	Last 6-9 months  |		 Standard		|		VO		|	Show All				|	Last 6-9 months		| 			New		  |ACTIVE_ARCHIVE_PAYMENTS_INDICATOR|	N|
      |   		Super	 	  | 		PROV		|	Last 9-13 months |		 Standard		|		AO		|	Show All				|	Last 9-13 months	| 			New		  |ACTIVE_ARCHIVE_PAYMENTS_INDICATOR|	N|
      |   		Super	    | 		PROV		|	Last 9-13 months |		 Standard		|		AV		|	Show All				|	Last 9-13 months	| 			New		  |ACTIVE_ARCHIVE_PAYMENTS_INDICATOR| N|
			|   		Super	    | 		PROV		|	Last 9-13 months |		 Standard		|		VO		|	Show All				|	Last 9-13 months	| 			New		  |ACTIVE_ARCHIVE_PAYMENTS_INDICATOR| N|
  
  #Author: AMIT
  @CSR_ViewPayments_US2801189 @OctRelease 
  Scenario Outline: Access Payments - View Payments Provider for Standard Experience
    Given User navigates to CSR portal and enters "<credentials>" and login
    When Click on View Payments Link
    Then Enter "<portalAccess>" portal access tin for "<tinType>" and "<searchCriteria>" criteria and click submit button
