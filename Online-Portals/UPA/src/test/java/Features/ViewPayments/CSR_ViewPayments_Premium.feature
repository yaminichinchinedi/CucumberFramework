...
Feature: View Payment Access Payment
  ...
  Scenario Outline: Access Payments - View Payments Provider for Premium Experience
    ...
    Examples:
			...
			|   		Super	 	  | 		PROV		|		Last 30 days	 |		 Premium		|		AV		|	Show All				|		Last 30 days		| 			New		  |ACTIVE_ARCHIVE_PAYMENTS_INDICATOR|	N|
			...
			|   		Super	 	  | 		PROV		|		Last 60 days	 |		 Premium		|		VO		|	Show All				|		Last 60 days		| 			New		  |ACTIVE_ARCHIVE_PAYMENTS_INDICATOR|	N|
			|   		Super	 	  | 		PROV		|		Last 90 days	 |		 Premium		|		AO		|	Show All				|		Last 90 days		| 			New		  |ACTIVE_ARCHIVE_PAYMENTS_INDICATOR|	N|
      ...
      |   		Super	 	  | 		PROV		|	Last 4-6 months  |		 Premium		|		AO		|	Show All				|	Last 4-6 months		| 			New		  |ACTIVE_ARCHIVE_PAYMENTS_INDICATOR|	N|
			|   		Super	 	  | 		PROV		|	Last 4-6 months	 |		 Premium		|		AV		|	Show All				|	Last 4-6 months		| 			New		  |ACTIVE_ARCHIVE_PAYMENTS_INDICATOR|	N|
      ...
      |   		Super	 	  | 		PROV		| Last 6-9 months  |		 Premium		|		AO		|	Show All				|	Last 6-9 months		| 			New		  |ACTIVE_ARCHIVE_PAYMENTS_INDICATOR|	N|
			...
			|   		Super	 	  | 		PROV		|	Last 6-9 months  |		 Premium		|		VO		|	Show All				|	Last 6-9 months		| 			New		  |ACTIVE_ARCHIVE_PAYMENTS_INDICATOR|	N|
